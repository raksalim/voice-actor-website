          ...
          <div className="about-image-col">
            ...
            <div className="about-social">
              ...
              <div className="social-links">
                <a href="https://www.tiktok.com/@asianactor" target="_blank" rel="noopener noreferrer" className="social-link tiktok">
                  ...
                  @asianactor on TikTok
                </a>
                <a href="https://www.youtube.com/@khmerish" target="_blank" rel="noopener noreferrer" className="social-link youtube">
                  <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
                ...
                <a href="https://www.instagram.com/actor.raksa/" target="_blank" rel="noopener noreferrer" className="social-link instagram">
                  <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
