		...
		<footer className="footer">
			<div className="footer-container">
				...
				<div className="footer-social">
					<a
						href="https://www.tiktok.com/@asianactor"
						target="_blank"
					...
					<a
						href="https://www.youtube.com/@khmerish"
						target="_blank"
						rel="noopener noreferrer"
					...
					<a
						href="https://www.instagram.com/actor.raksa/"
						target="_blank"
						rel="noopener noreferrer"
				...
				<p className="footer-copy">
					&copy; {new Date().getFullYear()} Raksa Lim. All rights
					reserved.
				</p>
			</div>
		</footer>
